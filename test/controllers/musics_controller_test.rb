...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { points: @music.points, song_name: @music.song_name, song_popularity: @music.song_popularity } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { points: @music.points, song_name: @music.song_name, song_popularity: @music.song_popularity } }
